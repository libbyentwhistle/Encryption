...
The first block of code is a very simple one, the second block of code allows the viewer to add their own message and see it be encrypted. 

The simple encryption is called a **reverse cipher**
